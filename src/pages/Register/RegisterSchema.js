...
export const RegisterSchema = z.object({
    username: z.string().min(1, { message: 'El campo es requerido' }).max(20, { message: 'El nombre de usuario no puede tener más de 20 caracteres' }),
    nombre: z.string().min(1, { message: 'El campo es requerido' }).max(20, { message: 'El nombre no puede tener más de 20 caracteres' }),
    apellido: z.string().min(1, { message: 'El campo es requerido' }).max(20, { message: 'El apellido no puede tener más de 20 caracteres' }),
    email: z.string().min(1, { message: 'El campo es requerido' }).email({ message: 'El formato del email no es válido' }).max(255),
    rol: z.string().min(1, { message: 'Debe seleccionar un rol' }),
